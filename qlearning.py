...
def main():
    ...
    for episode in range(episode_number):
        ...
        while(t < t_max):
            ...
            thresh=image_utils.simple_threshold(blurred)[0:top_bound, left_bound:right_bound]
            ...
            if lines is not None:
                ...
                if lines[0][0]==lines[1][0]:
                    ...
                    average_slope=(lines[0][1]-lines[1][1])/(lines[0][0]-lines[1][0])
                    average_slope_array.append((lines[0][1]-lines[1][1])/(lines[0][0]-lines[1][0]))
